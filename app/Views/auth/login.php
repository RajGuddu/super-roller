...
<head>
  ...
  <title>Login - Super Roller</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="<?=base_url('public/assets/admin/img/logo.png')?>" alt="">
                  <span class="d-none d-lg-block">Super Roller</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?=base_url(ADMIN_LOGIN)?>" method="post" class="row g-3 " >
                    <?=csrf_field()?>
                    <div class="col-12">
                      ...
                      <div class="text-danger"><?php echo isset($validation) ? $validation->showError('email') : ''; ?> </div>
                    </div>

                    <div class="col-12">
                      <label for="password" class="form-label">Password</label>
                      <input type="password" name="password" class="form-control" id="password" value="<?=set_value('password') ?>">
                      <div class=""><small class="text-danger"><?php echo isset($validation) ? $validation->showError('password') : ''; ?> </small></div>
                    </div>

                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="rememberme" value="1" id="rememberme" <?=set_checkbox('rememberme', '1'); ?>>
