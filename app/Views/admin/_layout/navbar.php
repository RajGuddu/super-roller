    ...
    <ul class="d-flex align-items-center">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
            <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('/admin/setting'); ?>">
            ...
            <?php /* <li>
            <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('change-password'); ?>">
