...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2024 at 12:02 PM
...
(1, 'Bon Voyagee', 'admin@admin.com', '$2y$10$klyldV0.GcDElwdIkglZrOCpaxmddHpsvlczah5pofNXOhAbpNByu', '::1', '2356896589', 'dp_1676868972.jpg', 1, 'delhi', 1, 1, 1, '2021-09-06 10:23:19', '2024-05-03 06:43:51'),
...
INSERT INTO `tbl_attributes` (`attr_id`, `pro_id`, `attr_value`, `unit_id`, `mrp`, `sp`, `stock`, `status`, `added_at`, `update_at`) VALUES
(1, 1, 5, 2, 250.00, 230.00, 10, 1, '2024-05-21 00:00:00', '2024-05-21 09:43:26'),
(2, 1, 25, 2, 800.00, 750.00, 10, 1, '2024-05-21 09:46:57', '0000-00-00 00:00:00');
...
CREATE TABLE `tbl_contact_us` (
  ...
  `subject` int(2) NOT NULL COMMENT 'tbl_timeshare.id',
  `message` text NOT NULL,
  `ipaddress` varchar(100) NOT NULL,
  `added_at` datetime NOT NULL,
  `status` int(11) NOT NULL COMMENT '1-New,2-Old'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_contact_us` (`id`, `name`, `country`, `email`, `phone`, `subject`, `message`, `ipaddress`, `added_at`, `status`) VALUES
(1, 'raju', 0, 'raju@yopmail.com', '9162925142', 0, 'test', '157.35.7.197', '2023-08-16 23:06:46', 1),
(2, 'md raj guddu', 0, 'gd@yopmail.com', '9162925142', 0, 'dsgsdsdfsdf', '157.35.7.197', '2023-08-16 23:56:31', 1),
(3, 'kumdan kumar', 0, 'kundan@yopmail.com', '1234567890', 0, 'testing', '157.35.18.175', '2023-08-19 07:51:49', 1),
(4, 'test bon', 99, 'test115@yopmail.com', '1234567890', 4, 'test', '::1', '2024-05-11 16:06:31', 1),
(5, 'test2', 2, 'test2@yopmail.com', '1234567890', 2, 'test message', '::1', '2024-05-11 16:24:25', 2),
(6, 'raj guddu', 2, 'rajgudduara18@gmail.com', '1234567890', 0, 'test', '::1', '2024-05-20 15:58:05', 1);
...
CREATE TABLE `tbl_product` (
  ...
  `homeimage_alt` varchar(255) NOT NULL,
  `homeimage_title` varchar(255) NOT NULL,
  `detail_image` varchar(150) NOT NULL,
  `detail_image_alt` varchar(255) NOT NULL,
  `detail_image_title` varchar(255) NOT NULL,
  `detail_para` varchar(255) NOT NULL,
  `ingred_desc` text NOT NULL,
  `ingredients` text NOT NULL,
  `is_popular` int(2) NOT NULL,
  `status` int(2) NOT NULL COMMENT '0-inactive, 1-active',
  `added_at` datetime NOT NULL,
  `update_at` datetime NOT NULL,
  `current_tab` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_product` (`pro_id`, `product_name`, `short_desc`, `url`, `home_image`, `homeimage_alt`, `homeimage_title`, `detail_image`, `detail_image_alt`, `detail_image_title`, `detail_para`, `ingred_desc`, `ingredients`, `is_popular`, `status`, `added_at`, `update_at`, `current_tab`) VALUES
(1, 'hanumanta atta 25kg', 'Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s,', 'hanumanta-atta-25kg', '', '', '', 'best-atta.webp', '', '', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, ', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, ', '', 0, 0, '2024-05-21 06:59:14', '2024-05-21 07:32:23', 4);
...
(1, '204/b, Lovely Home, Overy Pada Road, Dahisar (east), Mumbai', '+91 563 5633 556', 'info@superroller.com', '', '', '', '', '', 'Super Roller', 'www.website.com', 'https://www.facebook.com/', 'https://twitter.com/', '', '', 'http://youtube.com/', 'https://www.instagram.com/', '');
...
CREATE TABLE `tbl_units` (
  ...
  `unit_fullname` varchar(200) NOT NULL,
  `status` int(2) NOT NULL,
  `added_at` datetime NOT NULL,
  `update_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_units` (`id`, `unit`, `unit_fullname`, `status`, `added_at`, `update_at`) VALUES
(1, 'PC', 'piece', 1, '2024-05-21 07:49:41', '2024-05-21 07:49:41'),
(2, 'KG', 'Killo Gram', 1, '2024-05-21 07:49:41', '2024-05-21 07:49:41'),
(3, 'GM', 'Gram', 1, '2024-05-21 07:49:41', '2024-05-21 07:49:41');
